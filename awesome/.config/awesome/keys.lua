...
keys.globalkeys = gears.table.join(
	...
	end, { description = "hide wibar", group = "screen" }),
	...
	end, { description = "start emacs", group = "launcher" }),

	awful.key({ Modkey }, "n", function()
		awful.spawn(apps.file_manager)
	end, { description = "show the file browser", group = "launcher" }),
	...
	awful.key({ "Shift" }, "Print", function()
		awful.spawn(apps.directScreenshot)
	end, { description = "Take screenshot", group = "launcher" }),
	awful.key({ Modkey, "Shift" }, "v", function()
		awful.spawn(apps.vpn)
	end, { description = "Open VPN", group = "launcher" }),

	awful.key({ Modkey }, "v", function()
		awful.spawn(apps.video_link)
	end, { description = "Open video link", group = "launcher" }),
	...
	end, { description = "toggle side bar", group = "launcher" }),

	-- Macro pad
	--
	awful.key({ Modkey }, "F1", function()
		awful.spawn("wezterm")
	end, { description = "Macro pad shortcut", group = "launcher" }),
